...
describe('HelpPage', () => {
  ...
  it('should render all help sections', () => {
    ...
    expect(screen.getByTestId('help-section-tenants')).toBeInTheDocument()
  ...
  it('should display section titles correctly', () => {
    ...
    expect(screen.getByRole('heading', { name: /Tenants/i, level: 6 })).toBeInTheDocument()
  ...
  it('should display help content with description text', () => {
    ...
    // Verify tenants section contains the title and description is present
    const tenantsSection = screen.getByTestId('help-section-tenants')
    expect(tenantsSection).toBeInTheDocument()
    expect(tenantsSection.textContent).toContain('Tenants')
    expect(tenantsSection.textContent).toContain('isolated instance')
  })
  ...
  it('should support Spanish language', async () => {
    ...
    const inquilinosHeading = screen.queryByRole('heading', { name: /Inquilinos/i, level: 6 })
    expect(inquilinosHeading).toBeInTheDocument()
